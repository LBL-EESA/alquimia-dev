! Source code in this file originated from :
...
! otherwise noted."
!
! NOTE(bja): As of 2012-12-19, the fortranwiki.org c_interface_module
! page does not contain any additional copyright notice, so we can
! assume it is in the public domain.
